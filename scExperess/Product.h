...
Product Create_Product(char* name, char* category, int sn, int quantity, double price, int Discount);//create and return product object
...
double Get_Price(Product p);//return calculated price after discount
